...
public class ProductTestCase {
	...
	public void testCRUDProduct(){
		...
		assertEquals("something went wrong while updating the existing records!",true,productDAO.update(product));
		
		//deleting records
		assertEquals("something went wrong while deleting the existing records!",true,productDAO.delete(product));
